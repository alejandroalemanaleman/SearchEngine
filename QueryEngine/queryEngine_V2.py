...
def search_book(words_datamart, word):
    """cargamos los libros asociados a una palabra del datamart si esta se encuentra"""

    word_path = os.path.join(words_datamart, word)

    return readJSON(word_path)
...
def execute(words_datamart, metadata_datamart, datalake_path):
    ...
    while True:
        ...
        while len(words) > 0:
            ...
            books = search_book(words_datamart, word)
